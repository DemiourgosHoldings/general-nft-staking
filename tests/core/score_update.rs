...
fn update_deb_triggers_secure_rewards() {
    ...
    setup.set_aggregated_score(StakingModuleType::All, 10);
...
fn update_deb_updates_general_score() {
    ...
    setup.update_user_deb(2 * DEB_DENOMINATION);
    setup.assert_aggregated_score(StakingModuleType::All, 2);
}
...
fn update_deb_with_score_zero_success() {
    ...
    setup.update_user_deb(2 * DEB_DENOMINATION);
    setup.assert_aggregated_score(StakingModuleType::All, 0);
}
